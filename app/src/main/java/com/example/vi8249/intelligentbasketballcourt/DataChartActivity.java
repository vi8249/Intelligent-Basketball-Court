...
public class DataChartActivity extends Fragment {
        ...
        public void onClick(View v) {
            if(textView.getText().equals("Start Time")) {
                new android.app.AlertDialog.Builder(getActivity())
                        .setTitle("Warning")
                        .setMessage("InValid Input! Please select Start Time first!")
                ...
                new DatePickerDialog(rootView.getContext(), new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int month, int day) {
                        ...
                        if ((date1.getTime() > date2.getTime()) || (date1.getTime() == date2.getTime())) {
                            new android.app.AlertDialog.Builder(getActivity())
                                    .setTitle("Warning")
                                    .setMessage("InValid Input! End Time must bigger than Start Time")
                                    .setNeutralButton("OK", new DialogInterface.OnClickListener() {
                                        @Override
                                        public void onClick(DialogInterface dialog, int which) {
                                        }
    ...
    private void setUrl() {
        ...
        //Log.d("timestamp", url[0]);
        //Log.d("timestamp", url[1]);
    }
